...
<head>
  ...
  <title>Ошибка | Онлайн-курсы подготовки по олимпиадной экономике</title>
...
<body>
  ...
  <div class="paymentForm" id="form_olymp">
    ...
    <img class="afterPaymentImg" src="images/payment/cancel.svg" alt="Оплата прошла успешно">
    <p class="paymentText">
      При покупке курса возникла ошибка. Повторите попытку позже.
    </p>
  </div>
</body>
</html>
