  ...
  if(
    ...
    (isset($_POST['vk'])&&$_POST['vk']!=""&&(strlen($_POST['vk'])<50)&&stripos($_POST['vk'],'vk.com/')!==false)&&strlen($_POST['vk'])>8){
      if($_POST['main_f']){//Основной
          ...
          $vars['returnUrl'] = 'https://economolymp.ru/successful.php?course-link=imtweebr';
          ...
          // URL куда клиент вернется в случае успешной оплаты.
          $vars['returnUrl'] = 'https://economolymp.ru/successful.php?course-link=/iyjninze';
      ...
      } else if($_POST['package-advanced_f']){//Основной
