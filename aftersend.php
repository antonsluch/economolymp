...
<head>
  ...
  <title>Спасибо! | Онлайн-курсы подготовки по олимпиадной экономике</title>
...
<body>
  ...
  <div class="paymentForm" id="form_olymp">
    <a href="index.php"><img class="paymentLogo" src="images/logo/logo_top.png" alt="" /></a>
    <p class="paymentTextBold">
      Спасибо за интерес к Экономическому Олимпу! Все данные были отправлены Вам на почту. Перейдите на главную.
    </p>
    <a class="afterPayment" href="index.php">Главная</a>
  </div>
</body>
</html>
